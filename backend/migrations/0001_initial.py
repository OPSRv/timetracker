    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_picture', models.ImageField(default='user_picture/default_user_picture.png', upload_to=backend.models.upload_to_user_picture, verbose_name='Завантаження фото')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=1024), blank=True, size=None)),
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Project', to='backend.project')),
            ],
            options={
                'verbose_name': 'Task',
